...
const docsBase = normalizeBase(process.env.DOCS_BASE || '/projects/AiBlock/en/latest/')
const currentVersion = process.env.DOCS_VERSION || 'latest'
...
export default defineConfig({
  base: docsBase,
  title: 'AiBlock Documentation',
  description: 'AiBlock robot documentation',
