...
2. **Skill Objectives**: Assemble the mechanical chassis of the horizontal bar hero accurately, mastering worm gear alignment techniques. Wire the 360бу block motor, RGB light module, and touch sensor to designated controller ports. Program touch-triggered routines coordinating motor locomotion with breathing visual feedback.
