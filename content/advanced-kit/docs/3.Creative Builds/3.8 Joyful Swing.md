...
- Complete Program
  ...
  After powering on, short-pressing the left button serves as the startup trigger condition. Once triggered, the program enters an infinite loop: inside the loop, it first rotates servo S1 without delay to 45бу at 40% speed, waits 0.5 s, then rotates servo S1 without delay to 135бу at 40% speed, waits another 0.5 s, and repeats this sequence continuously.
