...
1. **Knowledge Objectives**: Understand operating principles of drum steamrollers. Master acoustic threshold trigger logic using the sound sensor. Recognize coordinated operations among the sound sensor, RGB light module, and 360бу block motor.
