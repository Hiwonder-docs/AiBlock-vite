...
2. **Skill Objectives**: Assemble the mechanical structure of the fighter jet independently, wiring four electronic peripherals accurately. Program dual 360бу block motors to drive the propeller and landing gear wheels independently. Implement synchronized red breathing effects across dual RGB light modules.
...
- Connect the 360бу block motor controlling the front propeller to port **S1** of the controller using a 3-pin servo cable.

- Connect the 360бу block motor controlling the landing gear wheels to port **S2** of the controller using a 3-pin servo cable.
