...
- Complete Program
  ...
  Upon entering the main program after power-on, an infinite loop begins to continuously read the light intensity from port A. If the light reading is greater than or equal to 80, the system waits for 0.5 s and directs servo S1 to rotate to 0бу at 20% speed without delay. If the light reading is less than 80, the system waits for 0.5 s and directs servo S1 to rotate to 120бу at 20% speed without delay. This monitoring and actuation process repeats continuously.
