...
- Complete Program
  ...
  1. When executing the main program, servo S1 rotates to 90бу at 30% speed without delay. After a delay of 2 s, motor S2 engages in reverse rotation at 18% speed.

  2. Button event logic is configured simultaneously:
     - Short-pressing the left button directs servo S1 to rotate to 60бу at 30% speed without delay.
     
     - Short-pressing the right button directs servo S1 to rotate to 120бу at 30% speed without delay.
