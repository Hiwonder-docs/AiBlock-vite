...
| <img src="../../_static/media/chapter_4/section_2/subsection_3/sub_7/4.png"> | <img src="../../_static/media/chapter_4/section_2/subsection_3/sub_7/0.png"> | Directs the 180° block servo on the designated port to rotate to a target angle at a custom speed, where selecting non-delay mode allows immediate execution of subsequent blocks |
...
- Complete Program
  ...
  Upon startup, the F1 Speed Race Car advances continuously. When the left button is pressed, servo S1 rotates to 30° at 20% speed to steer the F1 Speed Race Car left. When the right button is pressed, servo S1 rotates to 150° at 20% speed to steer the F1 Speed Race Car right.
