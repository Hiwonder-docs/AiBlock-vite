...
The core project for this lesson is the motorized lever seesaw, where a servo drives a long beam to pivot around a fulcrum via a connecting rod. The mechanism applies lever principles, with the servo oscillating between 0бу and 180бу to convert rotational motion into vertical see-saw swinging. The program uses a loop to rotate the servo to 0бу, hold for 1 s, rotate to 180бу, hold for 1 s, and repeat for sustained motion. Assembly requires ensuring a wide base and a sturdy pivot. Modifying angles alters swinging amplitude, while changing wait times adjusts cycle speed, visually illustrating how parameters govern mechanical movement.
...
- Complete Program
  ...
  After powering on, the program enters an infinite loop. Within the loop, it first commands servo S1 to rotate without delay to 0бу at 20% speed, waits 1 s, then commands servo S1 to rotate without delay to 180бу at 20% speed, waits another 1 s, and repeats this rotation cycle continuously.
