const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.B56UEQdk.js","assets/chunks/framework.BcZGpqhK.js"])))=>i.map(i=>d[i]);
...
const _sfc_main$o = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.B56UEQdk.js"), true ? __vite__mapDeps([0,1]) : void 0));
