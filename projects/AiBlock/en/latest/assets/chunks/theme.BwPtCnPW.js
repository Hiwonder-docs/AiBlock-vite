const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.CJv4CujU.js","assets/chunks/framework.CF6WwSqe.js"])))=>i.map(i=>d[i]);
...
const _sfc_main$o = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.CJv4CujU.js"), true ? __vite__mapDeps([0,1]) : void 0));
