const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.CBBXMqpO.js","assets/chunks/framework.DNxAzG3c.js"])))=>i.map(i=>d[i]);
...
const _sfc_main$o = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.CBBXMqpO.js"), true ? __vite__mapDeps([0,1]) : void 0));
